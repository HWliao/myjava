...
import static com.leyoujia.coa.zc.mall.dao.erp.auto.JhsTradeOrderDynamicSqlSupport.*;
...
@Mapper
public interface IJhsTradeOrderAutoDAO {
    ...
    int insert(InsertStatementProvider<JhsTradeOrder> insertStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: JHS_TRADE_ORDER")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ResultMap("JhsTradeOrderResult")
    JhsTradeOrder selectOne(SelectStatementProvider selectStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: JHS_TRADE_ORDER")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ResultMap("JhsTradeOrderResult")
    List<JhsTradeOrder> selectManyWithRowbounds(SelectStatementProvider selectStatement, RowBounds rowBounds);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: JHS_TRADE_ORDER")
    default Function<SelectStatementProvider, List<JhsTradeOrder>> selectManyWithRowbounds(RowBounds rowBounds) {
        return selectStatement -> selectManyWithRowbounds(selectStatement, rowBounds);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: JHS_TRADE_ORDER")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @Results(id="JhsTradeOrderResult", value = {
        ...
        @Result(column="REFUND_REIMBURSEMENT_ID", property="refundReimbursementId", jdbcType=JdbcType.INTEGER),
        @Result(column="EXCHANGE_METHOD", property="exchangeMethod", jdbcType=JdbcType.INTEGER),
        @Result(column="EXCHANGE_LINK", property="exchangeLink", jdbcType=JdbcType.VARCHAR),
    ...
    List<JhsTradeOrder> selectMany(SelectStatementProvider selectStatement);
    ...
    default DeleteDSL<MyBatis3DeleteModelAdapter<Integer>> deleteByExample() {
        return DeleteDSL.deleteFromWithMapper(this::delete, jhsTradeOrder);
    }
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: JHS_TRADE_ORDER")
    default int insert(JhsTradeOrder record) {
        return insert(SqlBuilder.insert(record)
                ...
                .map(refundReason).toProperty("refundReason")
                .map(refundReimbursementId).toProperty("refundReimbursementId")
                .map(exchangeMethod).toProperty("exchangeMethod")
                .map(exchangeLink).toProperty("exchangeLink")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: JHS_TRADE_ORDER")
    default int insertSelective(JhsTradeOrder record) {
        return insert(SqlBuilder.insert(record)
                .into(jhsTradeOrder)
                ...
                .map(refundReason).toPropertyWhenPresent("refundReason", record::getRefundReason)
                .map(refundReimbursementId).toPropertyWhenPresent("refundReimbursementId", record::getRefundReimbursementId)
                .map(exchangeMethod).toPropertyWhenPresent("exchangeMethod", record::getExchangeMethod)
                .map(exchangeLink).toPropertyWhenPresent("exchangeLink", record::getExchangeLink)
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: JHS_TRADE_ORDER")
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<JhsTradeOrder>>> selectByExample(RowBounds rowBounds) {
        return SelectDSL.selectWithMapper(selectManyWithRowbounds(rowBounds), id, orderNo, type, commodityId, commodityName, price, count, total, ofrom, status, workerId, workerName, createDate, sellerId, sellerName, sellerDeptId, sellerDeptName, buyerDeptId, buyerDeptName, integral, standard, recipients, buyerTel, buyerAddress, remarks, province, city, area, shopAddr, postCompany, postNo, payDate, deliverDate, deliverMsg, receiptDate, takeType, isCreateHappy, payMethod, dicttext, printDate, paymentDate, stopTradeDate, dataVersion, reimbursementId, refundReason, refundReimbursementId, exchangeMethod, exchangeLink, exchangeCode, biDate)
                .from(jhsTradeOrder);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: JHS_TRADE_ORDER")
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<JhsTradeOrder>>> selectByExample() {
        return SelectDSL.selectWithMapper(this::selectMany, id, orderNo, type, commodityId, commodityName, price, count, total, ofrom, status, workerId, workerName, createDate, sellerId, sellerName, sellerDeptId, sellerDeptName, buyerDeptId, buyerDeptName, integral, standard, recipients, buyerTel, buyerAddress, remarks, province, city, area, shopAddr, postCompany, postNo, payDate, deliverDate, deliverMsg, receiptDate, takeType, isCreateHappy, payMethod, dicttext, printDate, paymentDate, stopTradeDate, dataVersion, reimbursementId, refundReason, refundReimbursementId, exchangeMethod, exchangeLink, exchangeCode, biDate)
                .from(jhsTradeOrder);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: JHS_TRADE_ORDER")
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<JhsTradeOrder>>> selectDistinctByExample(RowBounds rowBounds) {
        return SelectDSL.selectDistinctWithMapper(selectManyWithRowbounds(rowBounds), id, orderNo, type, commodityId, commodityName, price, count, total, ofrom, status, workerId, workerName, createDate, sellerId, sellerName, sellerDeptId, sellerDeptName, buyerDeptId, buyerDeptName, integral, standard, recipients, buyerTel, buyerAddress, remarks, province, city, area, shopAddr, postCompany, postNo, payDate, deliverDate, deliverMsg, receiptDate, takeType, isCreateHappy, payMethod, dicttext, printDate, paymentDate, stopTradeDate, dataVersion, reimbursementId, refundReason, refundReimbursementId, exchangeMethod, exchangeLink, exchangeCode, biDate)
                .from(jhsTradeOrder);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: JHS_TRADE_ORDER")
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<JhsTradeOrder>>> selectDistinctByExample() {
        return SelectDSL.selectDistinctWithMapper(this::selectMany, id, orderNo, type, commodityId, commodityName, price, count, total, ofrom, status, workerId, workerName, createDate, sellerId, sellerName, sellerDeptId, sellerDeptName, buyerDeptId, buyerDeptName, integral, standard, recipients, buyerTel, buyerAddress, remarks, province, city, area, shopAddr, postCompany, postNo, payDate, deliverDate, deliverMsg, receiptDate, takeType, isCreateHappy, payMethod, dicttext, printDate, paymentDate, stopTradeDate, dataVersion, reimbursementId, refundReason, refundReimbursementId, exchangeMethod, exchangeLink, exchangeCode, biDate)
                .from(jhsTradeOrder);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: JHS_TRADE_ORDER")
    default JhsTradeOrder selectByPrimaryKey(Integer id_) {
        return SelectDSL.selectWithMapper(this::selectOne, id, orderNo, type, commodityId, commodityName, price, count, total, ofrom, status, workerId, workerName, createDate, sellerId, sellerName, sellerDeptId, sellerDeptName, buyerDeptId, buyerDeptName, integral, standard, recipients, buyerTel, buyerAddress, remarks, province, city, area, shopAddr, postCompany, postNo, payDate, deliverDate, deliverMsg, receiptDate, takeType, isCreateHappy, payMethod, dicttext, printDate, paymentDate, stopTradeDate, dataVersion, reimbursementId, refundReason, refundReimbursementId, exchangeMethod, exchangeLink, exchangeCode, biDate)
                .from(jhsTradeOrder)
                .where(id, isEqualTo(id_))
                .build()
                .execute();
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: JHS_TRADE_ORDER")
    default UpdateDSL<MyBatis3UpdateModelAdapter<Integer>> updateByExample(JhsTradeOrder record) {
        return UpdateDSL.updateWithMapper(this::update, jhsTradeOrder)
                ...
                .set(refundReason).equalTo(record::getRefundReason)
                .set(refundReimbursementId).equalTo(record::getRefundReimbursementId)
                .set(exchangeMethod).equalTo(record::getExchangeMethod)
                .set(exchangeLink).equalTo(record::getExchangeLink)
                .set(exchangeCode).equalTo(record::getExchangeCode)
                .set(biDate).equalTo(record::getBiDate);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: JHS_TRADE_ORDER")
    default UpdateDSL<MyBatis3UpdateModelAdapter<Integer>> updateByExampleSelective(JhsTradeOrder record) {
        return UpdateDSL.updateWithMapper(this::update, jhsTradeOrder)
                ...
                .set(refundReason).equalToWhenPresent(record::getRefundReason)
                .set(refundReimbursementId).equalToWhenPresent(record::getRefundReimbursementId)
                .set(exchangeMethod).equalToWhenPresent(record::getExchangeMethod)
                .set(exchangeLink).equalToWhenPresent(record::getExchangeLink)
                .set(exchangeCode).equalToWhenPresent(record::getExchangeCode)
                .set(biDate).equalToWhenPresent(record::getBiDate);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: JHS_TRADE_ORDER")
    default int updateByPrimaryKey(JhsTradeOrder record) {
        return UpdateDSL.updateWithMapper(this::update, jhsTradeOrder)
                .set(orderNo).equalTo(record::getOrderNo)
                .set(type).equalTo(record::getType)
                .set(commodityId).equalTo(record::getCommodityId)
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: JHS_TRADE_ORDER")
    default int updateByPrimaryKeySelective(JhsTradeOrder record) {
        return UpdateDSL.updateWithMapper(this::update, jhsTradeOrder)
                .set(orderNo).equalToWhenPresent(record::getOrderNo)
                .set(type).equalToWhenPresent(record::getType)
                .set(commodityId).equalToWhenPresent(record::getCommodityId)
